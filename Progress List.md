...
> Текущая версия: **v0.2.0** (14.05.2026)
...
### v0.2.0 (14.05.2026)
- Парсер КМД: 534/534 строки, 100% совпадение с эталоном (263 813 кг, 5 623 м²)
- OGZ-калькулятор: расчёт ПТМ, подбор составов, спецификация материалов
- CRM-модуль: CRUD клиентов, проекты с привязкой
- API: 15+ эндпоинтов (парсинг, проекты, клиенты, OGZ, сотрудники, задачи, входящие)
- Frontend: React SPA с загрузкой PDF, таблицей результатов, экспортом
- Модули: сотрудники, задачи, входящие запросы, дашборд, настройки, поиск
- Миграции БД: 004 (7+ таблиц)

### v0.1.0 (13.05.2026)
- Архитектурный план, схема БД, базовый парсер л.2
- FastAPI-скелет, API парсинга и проектов
- Агенты, контекст проекта

---

*Последнее обновление: 14.05.2026 — v0.2.0*
